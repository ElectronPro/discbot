# This is the code for the bot , You can add more statements in the bot.js file to make your bot more intresting you so you can add more if commands like example
